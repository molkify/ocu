(() => {
      ...
      async fetch({ request: t }) {
        ...
        try {
          ...
          let r = new g(
            ...
            this,
            e,
            w.includes(t.method.toUpperCase()) ? null : await t.blob()
          );
          if (
            ...
            (r.headers.origin ||
              (e.meta.url.origin !== n.origin && t.mode === "cors")) &&
              (r.headers.origin = n.origin),
          ...
          if (
            (s.headers.location &&
              (s.headers.location = e.rewriteUrl(s.headers.location)),
            ...
            if (!/\s*?((inline|attachment);\s*?)filename=/i.test(n)) {
              ...
              s.headers[
                "content-disposition"
              ] = `${u}; filename=${JSON.stringify(v)}`;
            }
          }
          if (
            (s.headers["set-cookie"] &&
              (Promise.resolve(
                e.cookie.setCookies(s.headers["set-cookie"], a, e.meta)
              ).then(() => {
              ...
              case "worker":
                {
                  let n = [
                    ...
                    .join(",");
                  (s.body = `if (!self.__uv && self.importScripts) { ${e.createJsInject(
                    this.address,
                    this.bareClient.manfiest,
                    e.cookie.serialize(l, e.meta, !0),
                    t.referrer
                  )} importScripts(${n}); }
  `),
              ...
              case "iframe":
              case "document":
                S(e.meta.url, s.headers["content-type"] || "") &&
                  (s.body = e.rewriteHtml(await h.text(), {
                    document: !0,
          ...
          return ["document", "iframe"].includes(t.destination)
            ? (console.error(e), O(e, i, this.address))
  ...
  function S(o, t = "") {
    return (
      (p.mime.contentType(t || o.pathname) || "text/html").split(";")[0] ===
      "text/html"
    );
  }
  var m = class {
